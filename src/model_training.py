...
from config.paths_config import MODEL_OUTPUT_PATH, PROCESSED_TRAIN_DATA_PATH, PROCESSED_TEST_DATA_PATH 
from config.model_params import RANDOM_SEARCH_PARAMS, LIGHTGBM_PARAMS
...
class ModelTraining():
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            ...
            logger.info("Starting the Hyper Parameter Training")
    ...
    def evaluate_model(self, model, X_test, y_test):
        try:
            ...
            logger.info(f"Acuuracy Score : {accuracy}")
