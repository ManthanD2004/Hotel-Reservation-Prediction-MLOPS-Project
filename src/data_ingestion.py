...
from config.paths_config import CONFIG_PATH, RAW_DIR, RAW_FILE_PATH, TRAIN_FILE_PATH, TEST_FILE_PATH
import sys
...
class DataIngestion:
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.error(f"Error while downloading the CSV file as {e}")
    ...
    def split_data(self):
        try:
            ...
            raise CustomException("Failed to split data during training and test set", e)
