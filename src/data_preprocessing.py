...
from config.paths_config import CONFIG_PATH, PROCESSED_DIR, TRAIN_FILE_PATH, TEST_FILE_PATH, PROCESSED_TRAIN_DATA_PATH, PROCESSED_TEST_DATA_PATH
...
class DataProcessor():
    ...
    def preprocess_data(self, df):
        try:
            ...
            logger.info("Appying Label Encoding")
    ...
    def balance_data(self, df):
        try:
            ...
            logger.info("Data Balancing Sucessful")
    ...
    def process(self):
        try:
            ...
            logger.error(f"Error during Data Preprocessing Pipeline Step {e}")
            raise CustomException("Error while data preprocessing pipeline data", e)
